...
| WorkflowId      | Response.MediaWorkflowList  | 工作流ID | String    | 是   | 工作流唯一ID |
| State      | Response.MediaWorkflowList  | 工作流状态 | String    | 是   | 1.Active <br/> 2. Paused<br/>|
| CreateTime      | Response.MediaWorkflowList  | 创建时间 | String    | 是   | |
| UpdateTime      | Response.MediaWorkflowList  | 更新时间 | String    | 是   | |
| Topology  | Response.MediaWorkflowList  | 拓扑信息 | Container    | 是   |  同POST Workflow中的Request.MediaWorkflow.Topology|
