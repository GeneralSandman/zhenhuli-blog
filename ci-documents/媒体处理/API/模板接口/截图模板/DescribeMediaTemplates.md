## 功能描述
DescribeMediaTemplates用于搜索截图模板。
...
| ------------------ | ------- | -------------------------------------------------------- | --------- | ---- |---| ---- |
| Mode                | TemplateList.Snapshot | 截图模式 | String    | 是   | Interval | 1. 值范围：{Interval, Average}<br/> 2. Interval 表示间隔模式 Average 表示平均模式<br/> 3. Interval模式：Start，TimeInterval，Count参数生效。当设置Count，未设置TimeInterval时，表示截取所有帧，共Count张图片<br/> 4. Average模式：Start，Count参数生效。表示从Start开始到视频结束，按平均间隔截取共Count张图片|
...
| CIParam              | TemplateList.Snapshot | 截图图片处理参数  | String    | 否   | 无  | 1. 参考文档(https://cloud.tencent.com/document/product/460/36540) <br/> 2. 例如: imageMogr2/format/png |
